...
have_func("rl_variable_value")
have_func("rl_variable_bind")
have_func("rl_parse_and_bind")
have_func("rl_get_termcap")
have_func("rl_ding")
have_func("rl_expand_prompt")
have_func("rl_character_len")
have_func("rl_redisplay")
have_func("rl_forced_update_display")
have_func("rl_on_new_line")
have_func("rl_reset_line_state")
